...
parser.add_argument('--checkpoint', type=str, default='logs/models/model_last.th', help='The checkpoint to be pruned')
...
parser.add_argument('--mask-file', type=str, default='logs/models/mask_values.txt', help='The text file containing the mask values')
...
def pruning(net, neuron):
    ...
    state_dict[weight_name][int(neuron[1])] = 0
